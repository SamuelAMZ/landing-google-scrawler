                              ...
                              >
                                <tr>
                                  ...
                                  >
                                    ...
                                    >
                                      <p style="margin: 0">
                                        Dear ${data.stepData.username},
                                        <br /><br />
Thank you for reaching out to Takedownly for a free content report. We appreciate your trust in our service and will handle your request with the utmost care. Your report will be sent to you within 24 hours.
<br/><br/>
If you have any additional questions or concerns, please don't hesitate to contact us through the chat on our website or email us at <a href="mailto:contact@takedownly.com">contact@takedownly.com</a>.
<br/><br/>
  ...
  axios
    .post(
      url,
      {
        personalizations: [
          {
            to: [{ email: data.stepData.email, name: data.stepData.username }],
            subject: "Thank you!",
          },
        ],
